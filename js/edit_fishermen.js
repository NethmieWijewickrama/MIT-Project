...
window.setInterval(() => {
    ...
    // medical & cinec files not included in edit page
/*
    //dependent 1

    if ($('#d1name').val() != "" && $('#d1name').val() != null && ($('#d1name').val().match(nameReg))) {
    ...
    if ($('#d1tp').val() != "" && $('#d1tp').val() != null && ($('#d1tp').val().match(tpReg))) {
    ...
    if ($('#d2name').val() != "" && $('#d2name').val() != null && ($('#d2name').val().match(nameReg))) {
    ...
    if ($('#d2tp').val() != "" && $('#d2tp').val() != null && ($('#d2tp').val().match(tpReg))) {
...
$('#fishermenEdit_data').on('keyup keypress', function(e) {
